...
# ------- uncomment this code and comment line 131 to use our custom weights ---------------------
#dict_weights = {0:0.5, 1: 7, 2: 6, 3: 4, 4: 2, 6: 2}
#classifier=RandomForestClassifier(max_depth=20, min_samples_leaf=5, n_estimators=75, class_weight=dict_weights)
# ------------------------------------------------------------------------------------------------
classifier=RandomForestClassifier(max_depth=20, min_samples_leaf=5, n_estimators=75, class_weight='balanced') # balanced weights 
...
for train_index, test_index in cv.split(cuiPairs,pairs_ground):
    ...
    print('Pre resampling samples: ',Counter(y_train))

    # Define the original size of your majority class 
    original_majority_size = 68000 
    desired_majority_size = original_majority_size // 3 

    # Define the sampling strategy
    sampling_strategy = {0: desired_majority_size}

    # Create the RandomUnderSampler object with the custom sampling strategy
    ...
    # Assuming you have your training features (c_train) and labels (y_train)
    minority_class_label1 = 1  # Replace with the actual minority class label
    minority_class_label3 = 3

    # Set the desired number of examples for the minority class
    desired_minority_examples1 = 5000
    desired_minority_examples3 = 5000
    ...
    smote = SMOTE(k_neighbors=5, sampling_strategy={minority_class_label1: desired_minority_examples1, minority_class_label3: desired_minority_examples3})
    X_train,y_train = smote.fit_resample(X_train, y_train)
    print("Upsampling ready....!")
